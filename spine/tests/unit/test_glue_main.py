"""Unit tests for `spine.entrypoints.glue_main` — LLD §8.3, I-14, I-22, I-23, [H-5][T-13][T-16].
...
session anywhere in this file (that's `tests/integration/test_entrypoint.py`'s
job).
"""
